...
if any(field.strip() == "nama_data, sub_kegiatan_opd, unit_pengelola, sumber_data, deskripsi,
    tujuan, wilayah, waktu, metode, kualitas, indikator,
    pemanfaatan, rencana_bagi, format_data, pic" for field in data_fields):
